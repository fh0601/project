...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        a = matching.compute_consecutive_frame_similarity(strack_pool, detections)
        #dists = matching.fuse_iou(dists, strack_pool, detections)
        #dists = matching.iou_distance(strack_pool, detections)
        dists = matching.fuse_motion(self.kalman_filter, dists, strack_pool, detections, a)
        ...
        # dists = matching.fuses_iou(dists, r_tracked_stracks, detections)
