...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--load_model', default='../4ship-model_30.pth',
        ...
        self.parser.add_argument('--save_all', action='store_true',
                                 help='save model to disk every 1 epochs.')
        ...
        self.parser.add_argument('--track_buffer', type=int, default=100, help='tracking buffer')
        self.parser.add_argument('--min-box-area', type=float, default=200, help='filter out tiny boxes')
        self.parser.add_argument('--input-video', type=str, default='../4-5.mp4', help='path to the input video')
        ...
        self.parser.add_argument('--match_thres', type=float, default=0.4, help='confidence thresh for byte tracking')

        # mot
        self.parser.add_argument('--data_cfg', type=str,
                                 default='../src/lib/cfg/mot15.json',
                                 help='load data from cfg')
        self.parser.add_argument('--data_dir', type=str, default='../src/data/ship')
